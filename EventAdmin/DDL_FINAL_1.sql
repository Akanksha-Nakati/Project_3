...
CREATE TABLE Organization (
    ...
    event_schedule_id NUMBER(10) NOT NULL
);
...
CREATE TABLE Registration (
    registration_id NUMBER(10) NOT NULL PRIMARY KEY,
    attendee_id NUMBER(10) NOT NULL UNIQUE,
    event_id NUMBER(10) NOT NULL,
    registration_date TIMESTAMP,
    ticketsAvailable NUMBER NOT NULL,
...
ALTER TABLE Event ADD CONSTRAINT FK_Organizer_Event FOREIGN KEY (organizer_id) REFERENCES Organization(organization_id);
